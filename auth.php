               ...
               sendEmail(
                    ...
                    <div style='font-family: Arial, sans-serif; max-width: 500px; margin: auto; padding: 20px;'>
                        <div style='text-align:center; margin-bottom: 24px;'>
                            <img src='https://ghos.shop/images/logo/logo2.png' alt='Ghos Logo' style='height: 60px; border-radius: 8px;'>
                        </div>
...
<div class="auth-logo">
    <img src="images/logo/logo2.png" alt="Ghos Logo" style="height: 80px; margin-bottom: 20px; border-radius: 12px;">
    <h1 id="page-title">
