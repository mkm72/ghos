...
--
-- Host: localhost:3306
-- Generation Time: May 17, 2026 at 11:02 AM
...
(115, 'Zero Escape: The Nonary Games', 'Kidnapped and taken to an unfamiliar location, nine people find themselves forced to participate in a diabolical Nonary Game by an enigmatic mastermind called Zero. Why were they there? Why were they chosen to put their lives on the line as part of a dangerous life and death game? Who can be trusted? Tensions rise as the situation becomes more and more dire, and the nine strangers must figure out how to escape before they wind up dead.', 2.99, 'PC, Xbox One, PlayStation 4, PS Vita', 'Adventure', 4.38, NULL, NULL, NULL),
...
(1682, 'The Wolf Among Us', 'The Wolf Among Us is a five-part episodic game relying heavily on dialogues and choices of the player. The game is considered a prequel to Bill Willingham\'s \'Fables\' comic book and features usual TellTale stylistics: cartoon-like graphics, comparing your choices to the decisions of the other players and QTEs. \'The Wolf\' is the first part of the series with a promised expansion to the second season coming out in 2019.', 8.99, 'PC, PlayStation 4, Xbox One, iOS, Android, macOS, Xbox 360, PS Vita', 'Adventure', 4.39, NULL, NULL, NULL),
...
(9767, 'Hollow Knight', 'Hollow Knight is a Metroidvania-type game developed by an indie studio named Team Cherry.\r\n\r\nMost of the game\'s story is told through the in-world items, tablets, and thoughts of other characters. Many plot aspects are told to the player indirectly or through the secret areas that provide a bit of lore in addition to an upgrade. At the beginning of the game, the player visits a town of Dirtmouth. A town built above the ruins of Hallownest.', 7.48, 'PC, Xbox One, PlayStation 4, Nintendo Switch, macOS, Linux', 'Platformer, Indie, Action', 4.40, NULL, NULL, NULL),
...
(10073, 'Divinity: Original Sin 2', 'The Divine is dead. The Void approaches. And the powers latent within you are soon to awaken. The battle for Divinity has begun. Choose wisely and trust sparingly; darkness lurks within every heart.\r\n\r\nWho will you be? A flesh-eating elf; an imperial lizard; an undead risen from the grave? Choose your race and origin story - or create your own! Discover how the world reacts differently to who - and what - you are.It’s time for a new Divinity!', 11.24, 'PC, Xbox One, PlayStation 4, Nintendo Switch', 'Strategy, RPG', 4.38, NULL, NULL, NULL),
(10141, 'NieR:Automata', 'NieR: Automata is an action RPG, a sequel to Nier and a spin-off to the Drakenguard series. The story is set in the middle of the war between humans and machines where you take on the role of an android warrior called 2B. The story develops around the theme of androids\' ability to feel and make their own decisions.', 15.99, 'PC, Xbox One, PlayStation 4, Nintendo Switch', 'Action, RPG', 4.37, NULL, NULL, NULL),
(10389, 'Gothic II: Gold Edition', 'The second game from the series Gothic.\r\nIn the first game, people who inhabit a fantasy kingdom, lose the war to the orcs. To win, the king needs magical ore mined in local mines. The king decides to send to the mines everyone who is accused of any crime and create a magical Barrier around the mines so that no one can escape from the mines. However, Barrier surrounded a much larger area and the prisoners became masters inside the Barrier.', 4.99, 'PC', 'Action, RPG', 4.40, NULL, NULL, NULL),
...
(29642, 'Silent Hill 2 (2001)', 'In the sequel to Silent Hill, Silent Hill 2 follows James Sunderland, whose life is shattered when his young wife Mary suffers a tragic death. Three years later, a mysterious letter arrives from Mary, beckoning him to return to their sanctuary of memories, the dark realm of Silent Hill. You must guide James through all-new environments and creepy new areas closed off in the original game. Real-time weather effects, fog, morphing, and shadows set the stage for heart-stopping frights.', 34.99, 'PC, Xbox, PlayStation 2', 'Adventure, Action', 4.38, NULL, NULL, NULL),
...
(51610, 'Dark Souls: Remastered', 'Then, there was fire. Re-experience the critically acclaimed, genre-defining game that started it all. Beautifully remastered, return to Lordran in stunning high-definition detail running at 60fps.\r\nDark Souls Remastered includes the main game plus the Artorias of the Abyss DLC.', 39.99, 'PC, Xbox One, PlayStation 4, Nintendo Switch', 'Action, RPG', 4.48, NULL, NULL, NULL),
(52201, 'Yakuza 6: The Song of Life', 'How far will you go for family? Three years after the events of Yakuza 5, Kazuma Kiryu, the Dragon of Dojima, returns in Yakuza 6: The Song of Life with the dream of living a quiet life. Upon his arrival, he discovers Haruka has been involved in an accident and has slipped into a coma, leaving her young son, Haruto, without care. To protect this child, Kiryu takes Haruto to the last place Haruka was spotted, Onomichi, Hiroshima.', 10.99, 'PC, Xbox One, PlayStation 4', 'Shooter, Adventure, Action', 4.41, NULL, NULL, NULL),
...
(58175, 'God of War (2018)', 'It is a new beginning for Kratos. Living as a man outside the shadow of the gods, he ventures into the brutal Norse wilds with his son Atreus, fighting to fulfill a deeply personal quest. \r\n\r\nHis vengeance against the Gods of Olympus years behind him, Kratos now lives as a man in the realm of Norse Gods and monsters. It is in this harsh, unforgiving world that he must fight to survive… And teach his son to do the same.', 19.99, 'PC, PlayStation 4', 'Action', 4.54, NULL, NULL, NULL),
...
(428664, 'A Space for the Unbound', 'Check out the free prologue chapter here!https://store.steampowered.com/app/1201280/\r\nAbout the GameHigh school is ending and the world is ending with it\r\nA Space For The Unbound is a slice-of-life adventure game with beautiful pixel art set in the late 90s rural Indonesia that tells a story about overcoming anxiety, depression, and the relationship between a boy and a girl with supernatural powers.', 9.99, 'PC, Nintendo Switch', 'Indie, Adventure', 4.42, NULL, NULL, NULL),
...
(727319, 'ARK: Survival Evolved', 'Stranded on the shores of a mysterious island, you must learn to survive. Use your cunning to kill or tame the primeval creatures roaming the land, and encounter other players to survive, dominate... and escape!', 1.00, 'PC', 'action', 0.00, 11, NULL, NULL),
(727322, 'Dark Souls III: The Ringed City', 'Fear not, the dark, ashen one.  <br/>\r\nThe Ringed City is the final DLC pack for Dark Souls III – an award-winning, genre-defining Golden Joystick Awards 2016 Game of the year RPG.  Journey to the world’s end to search for the Ringed City and encounter new lands, new bosses, new enemies with new armor, magic and items.  Experience the epic final chapter of a dark world that could only be created by the mind of Hidetaka Miyazaki.       <br/>\r\nA New World.  One Last Journey.', 10.00, 'PC, Xbox One, PlayStation 4', 'Action, RPG', 0.00, 11, NULL, NULL);
